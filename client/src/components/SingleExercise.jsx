...
import cardioIcon from "../assets/images/wht-run-cardio.png"
import resistanceIcon from "../assets/images/wht-resist.png"
...
export default function SingleExercise() {
    ...
    const handleDeleteExercise = async (exerciseId) => {
        ...
        confirmAlert({
            ...
            message: "Do you want to permanently delete this exercise?",
            buttons: [
                {
                    label: "Cancel",
                },
